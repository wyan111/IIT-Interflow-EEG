...
% figure(1)
% h_TM = histogram(TMnew,[0:0.005:0.6]);h_TM.Normalization = 'probability';
% grid on;xlabel('R Squared');ylabel('Frequency');title('Histogram (bin = 0.005)')
% figure(2)
% h_RV = histogram(RVnew,[0:0.005:0.6]);h_RV.Normalization = 'probability';
% grid on;xlabel('R Squared');ylabel('Frequency');title('Histogram (bin = 0.005)')
% figure(3)
% h_OC = histogram(OCnew,[0:0.005:0.6]);h_OC.Normalization = 'probability';
% grid on;xlabel('R Squared');ylabel('Frequency');title('Histogram (bin = 0.5)')
% figure(4)
...
%TM
%figure(1)
hacr_TM = histogram(TM(64:126,1:63),[0:0.005:0.6]);
%hacr_TM.Normalization = 'probability';
grid on;xlabel('R Squared');ylabel('Frequency (Total counts = 3969)');title('Histogram (bin = 0.005)')
...
% set(gca,'xticklabel',{'0','0.00004','0.00008','0.0052','0.0056','0.0002','0.00024','0.00028','0.00032','0.00036','0.0004'});

%RV
figure(2)
hacr_RV = histogram(RV(64:126,1:63),[0:0.005:0.6]);
...
%OC
figure(3)
hacr_OC = histogram(OC(64:126,1:63),[0:0.005:0.6]);
...
% set(gca,'xticklabel',{'0','0.06','0.12','0.18','0.24','0.3','0.36','0.42','0.48','0.54','0.6'});

%Within
%TM
figure(4)
h_TMnew = histogram(TMnew,[0:0.005:0.6]);
hval_TMnew = h_TMnew.Values;
hwitval_TM = (hval_TMnew-hacrval_TM*2)/2;
tot_TM = sum(hwitval_TM);
TM_wit = hwitval_TM/tot_TM;
% bar(TM_wit);set(gca,'xticklabel',{'0','0.06','0.12','0.18','0.24','0.3','0.36','0.42','0.48','0.54','0.6'});
% grid on;xlabel('R Squared');ylabel('Frequency (Total counts after removing diagonal = 3906)');title('Histogram (bin = 0.005)')
cum4 = cumsum(hwitval_TM); 
bar(cum4/3906);grid on;xlabel('R Squared');ylabel('Cumulative sum');title('Cumulative (bin = 0.005)');
set(gca,'xticklabel',{'0','0.06','0.12','0.18','0.24','0.3','0.36','0.42','0.48','0.54','0.6'});
%RV
figure(5)
h_RVnew = histogram(RVnew,[0:0.005:0.6]);
hval_RVnew = h_RVnew.Values;
hwitval_RV = (hval_RVnew-hacrval_RV*2)/2;
tot_RV = sum(hwitval_RV);
RV_wit = hwitval_RV/tot_RV;
% bar(RV_wit);set(gca,'xticklabel',{'0','0.06','0.12','0.18','0.24','0.3','0.36','0.42','0.48','0.54','0.6'});
% grid on;xlabel('R Squared');ylabel('Frequency (Total counts after removing diagonal = 3906)');title('Histogram (bin = 0.005)')
cum5 = cumsum(hwitval_RV);
bar(cum5/3906);grid on;xlabel('R Squared');ylabel('Cumulative sum');title('Cumulative (bin = 0.005)');
set(gca,'xticklabel',{'0','0.06','0.12','0.18','0.24','0.3','0.36','0.42','0.48','0.54','0.6'});

%OC
figure(6)
h_OCnew = histogram(OCnew,[0:0.005:0.6]);
hval_OCnew = h_OCnew.Values;
hwitval_OC = (hval_OCnew-hacrval_OC*2)/2;
tot_OC = sum(hwitval_OC);
OC_wit = hwitval_OC/tot_OC;
% bar(OC_wit);set(gca,'xticklabel',{'0','0.06','0.12','0.18','0.24','0.3','0.36','0.42','0.48','0.54','0.6'});
% grid on;xlabel('R Squared');ylabel('Frequency (Total counts after removing diagonal = 3906)');title('Histogram (bin = 0.005)')
cum6 = cumsum(hwitval_OC);
bar(cum6/3906);grid on;xlabel('R Squared');ylabel('Cumulative sum');title('Cumulative (bin = 0.005)');
set(gca,'xticklabel',{'0','0.06','0.12','0.18','0.24','0.3','0.36','0.42','0.48','0.54','0.6'});
