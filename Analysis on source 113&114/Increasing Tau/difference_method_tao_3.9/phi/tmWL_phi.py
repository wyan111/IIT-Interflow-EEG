...
data = loadmat('/home/wyan111/qb48_scratch/wenqiIIT/phi/TPM_WLTM.mat')
tpm36SBS = np.array(data['TPM_WLTM'])
state00 = (0, 0)
state10 = (1, 0)
state01 = (0, 1)
state11 = (1, 1)
phiTMWLcell = np.zeros([148,148,4])
for num1 in range(0,148):
    for num2 in range(num1,148):
        ...
        phiTMWLcell[num1][num2] = np.array(phiarray)


savemat('phiTMWLcell',{'phiTMWLcell':phiTMWLcell})
