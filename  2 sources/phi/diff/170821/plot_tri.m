...
title('TM - Difference Binarise - 3.9 ms')
saveas(1,'TM.jpg')
...
set(gca,'xtick',[74,222]);set(gca,'ytick',[74,222])
set(gca,'xticklabel',{'Source 1~148 of P1','Source 1~148 of P2'});set(gca,'yticklabel',{'Source 1~148 of P1','Source 1~148 of P2'});
title('RV - Difference Binarise - 3.9 ms')
saveas(2,'RV.jpg')
...
set(gca,'xtick',[74,222]);set(gca,'ytick',[74,222])
set(gca,'xticklabel',{'Source 1~148 of P1','Source 1~148 of P2'});set(gca,'yticklabel',{'Source 1~148 of P1','Source 1~148 of P2'});
title('OC - Difference Binarise - 3.9 ms')
saveas(3,'OC.jpg')

save('sld-diff-tm-170821.mat','tm_tri');
save('sld-diff-rv-170821.mat','rv_tri');
save('sld-diff-oc-170821.mat','oc_tri');
...
set(gca,'xtick',[74,222]);set(gca,'ytick',[74,222])
set(gca,'xticklabel',{'Source 1~148 of P1','Source 1~148 of P2'});set(gca,'yticklabel',{'Source 1~148 of P1','Source 1~148 of P2'});
title('Average - Difference Binarise - 3.9 ms')
