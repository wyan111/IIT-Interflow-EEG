clear
dataset11 = load('TM11.mat');dataset21 = load('TM21.mat');
...
[wl113_1,wl113_2] = window_1_2(valuewl113);
[wl114_1,wl114_2] = window_1_2(valuewl114);
[md113_1,md113_2] = window_1_2(valuemd113);
[md114_1,md114_2] = window_1_2(valuemd114);
size_w1 = size(wl113_1);time_win1=size_w1(2);
size_w2 = size(wl113_2);time_win2=size_w2(2);
eponum = size_w1(1)
%eponum = 24
